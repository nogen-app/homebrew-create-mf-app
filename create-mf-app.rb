...
class CreateMfApp < Formula
  ...
  if Hardware::CPU.is_64_bit?
    ...
    when /mswin|msys|mingw|cygwin|bccwin|wince|emc/
      :windows
    when /darwin|mac os/
      url "https://github.com/nogen/create-mf-app/releases/download/v0.1.0/create-mf-app_0.1.0_darwin_amd64.zip"
      sha256 "2333f63ec58ac76d8132575f851ca1f9aefebfce4a1c82ab8d87d42c341d9eb3"
    when /linux/
      url "https://github.com/nogen/create-mf-app/releases/download/v0.1.0/create-mf-app_0.1.0_linux_amd64.tar.gz"
    ...
    when /darwin|mac os/
      :mac
    when /linux/
      url "https://github.com/nogen/create-mf-app/releases/download/v0.1.0/create-mf-app_0.1.0_linux_386.tar.gz"
